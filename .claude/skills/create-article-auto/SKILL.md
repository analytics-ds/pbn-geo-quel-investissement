...
**NE JAMAIS ecrire le nom du site dans le `title` du frontmatter.** Le theme l'ajoute deja tout seul : `themes/quel-investissement/layouts/_default/baseof.html` rend `{{ .Title }} | {{ .Site.Title }}`. Mettre le suffixe dans le frontmatter le fait sortir **deux fois** dans la balise, et comme le H1 est construit sur `.Title` a defaut de `.Params.h1`, le nom du site se retrouve aussi **dans le H1**. Defaut constate et corrige sur `meilleur-logiciel-sirh.com` le 2026-08-11 (16 articles) et sur `magazine-como` le 2026-09-01 (4 pages).
...
|---|---|---|---|
| fr | Quel Investissement | ` \| Quel Investissement` (22) | **38** |
| en | Quel Investissement | ` \| Quel Investissement` (22) | **38** |
